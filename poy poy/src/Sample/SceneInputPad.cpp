...
namespace
{
	...
	private:
		...
		// enumのPAD番号をu32に変換
		u32 convertPadNo( PAD_NO pad_no )
		{
			return static_cast<u32>( pad_no );
		}
	...
	public:
		...
		void setKing( const Player* king )
		{
			king_ = king;
		}
		void unsetKing()
